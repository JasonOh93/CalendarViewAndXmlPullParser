...
class AnimalDataFromFullAdapter(var animalDatas: ArrayList<AnimalDataFull>, val context: Context): RecyclerView.Adapter<AnimalDataFromFullAdapter.ViewHolder>() {

    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): AnimalDataFromFullAdapter.ViewHolder {
        return ViewHolder(
